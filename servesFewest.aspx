<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="servesFewest.aspx.cs" Inherits="Web2._0Assignment.servesFewest" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:dbmt16abkConnectionString %>" SelectCommand="SELECT [Author], [Id], [IngredientList], [Instructions], [Picture], [PostDate], [Title], [CookTime], [AverageScore], [Category], [Servings] FROM [RecipesPlusRatings] ORDER BY [Servings], [Title]"></asp:SqlDataSource>

    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1 style="font-family:'Times New Roman'; font-size:45px">Serves Fewest...</h1>
