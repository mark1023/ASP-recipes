<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="newestFirst.aspx.cs" Inherits="Web2._0Assignment.RecipesBySort" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:dbmt16abkConnectionString %>" SelectCommand="SELECT [CookTime], [Title], [PostDate], [Picture], [Instructions], [IngredientList], [Id], [Author], [Servings], [Category], [AverageScore] FROM [RecipesPlusRatings] ORDER BY [PostDate] DESC"></asp:SqlDataSource>

    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1 style="font-family:'Times New Roman'; font-size:45px">Newest First...</h1>
