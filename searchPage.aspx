<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="searchPage.aspx.cs" Inherits="Web2._0Assignment.searchPage" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:dbmt16abkConnectionString %>" SelectCommand="SELECT [IngredientList], [Picture], [Instructions], [Author], [Id], [PostDate], [CookTime], [Title], [Servings], [Category], [AverageScore] FROM [RecipesPlusRatings] WHERE ([Title] LIKE '%' + @Title + '%')">
        <SelectParameters>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1 style="font-family:'Times New Roman'; font-size:45px">Search Results For: <asp:Label ID="lbl_searchResult" runat="server" Text="Label"></asp:Label></h1>
            </div>
        </div>
    </div>
