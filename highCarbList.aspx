<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="highCarbList.aspx.cs" Inherits="Web2._0Assignment.highCarbList" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:dbmt16abkConnectionString %>" SelectCommand="SELECT [Author], [Id], [Picture], [PostDate], [Title], [CookTime], [AverageScore], [Category], [Servings] FROM [RecipesPlusRatings] WHERE ([Category] = @Category)">
        <SelectParameters>
            <asp:Parameter DefaultValue="High Carb" Name="Category" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1 style="font-family:'Times New Roman'; font-size:45px">High Carb List...</h1>
