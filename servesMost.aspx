<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="servesMost.aspx.cs" Inherits="Web2._0Assignment.servesMost" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">


    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:dbmt16abkConnectionString %>" SelectCommand="SELECT [CookTime], [Title], [PostDate], [Picture], [Instructions], [IngredientList], [Id], [Author], [Category], [Servings], [AverageScore] FROM [RecipesPlusRatings] ORDER BY [Servings] DESC, [Title]"></asp:SqlDataSource>
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1 style="font-family:'Times New Roman'; font-size:45px">Serves Most...</h1>
