<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CategoryHighestRated.aspx.cs" Inherits="Web2._0Assignment.categoryHighestRated" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:dbmt16abkConnectionString %>" SelectCommand="SELECT [AverageScore], [Category], [Servings], [Author], [Id], [IngredientList], [Instructions], [Picture], [PostDate], [Title], [CookTime] FROM [RecipesPlusRatings] WHERE ([Category] = @Category) ORDER BY [AverageScore] DESC">
        <SelectParameters>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1 style="font-family:'Times New Roman'; font-size:45px">Highest Rated... <%=Request.QueryString["Category"] %></h1>
