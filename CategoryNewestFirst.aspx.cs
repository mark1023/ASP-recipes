...
{
    public partial class CategoryNewestFirst : System.Web.UI.Page
    {
        ...
        {
            if (DropDownList1.SelectedItem.Value == "oldestFirst")
            {
            ...
            {
                Response.Redirect("~/CategoryLowestRated.aspx?Category=" + Request.QueryString["Category"]);
            }
