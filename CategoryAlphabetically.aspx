<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CategoryAlphabetically.aspx.cs" Inherits="Web2._0Assignment.CategoryAlphabetically" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:dbmt16abkConnectionString %>" SelectCommand="SELECT [Author], [Id], [IngredientList], [Instructions], [Picture], [PostDate], [Title], [CookTime], [AverageScore], [Category], [Servings] FROM [RecipesPlusRatings] WHERE ([Category] = @Category) ORDER BY [Title]">
        <SelectParameters>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1 style="font-family:'Times New Roman'; font-size:45px">Recipes A-Z... <%=Request.QueryString["Category"] %> </h1>
