<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="editRecipe.aspx.cs" Inherits="Web2._0Assignment.editRecipe" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <p>
        &nbsp;</p>

    <asp:Label ID="Label2" runat="server" Visible="false">You Can Only Edit A Recipe You Created </asp:Label>
    <asp:PlaceHolder runat="server" ID="showInfo">

         <h1 style="font-family:'Times New Roman'; font-weight:bold">Edit Your Recipe</h1>
