<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="longestTime.aspx.cs" Inherits="Web2._0Assignment.longestTime" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">


    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:dbmt16abkConnectionString %>" SelectCommand="SELECT [CookTime], [Title], [PostDate], [Picture], [Instructions], [IngredientList], [Id], [Author], [AverageScore], [Category], [Servings] FROM [RecipesPlusRatings] ORDER BY [CookTime] DESC"></asp:SqlDataSource>

     <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1 style="font-family:'Times New Roman'; font-size:45px">Longest Cook Time...</h1>
