<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CategoryShortestTime.aspx.cs" Inherits="Web2._0Assignment.CategoryShortestTime" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:dbmt16abkConnectionString %>" SelectCommand="SELECT [Author], [Id], [IngredientList], [Instructions], [Picture], [PostDate], [Title], [CookTime], [AverageScore], [Category], [Servings] FROM [RecipesPlusRatings] WHERE ([Category] = @Category) ORDER BY [CookTime]">
        <SelectParameters>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1 style="font-family:'Times New Roman'; font-size:45px">Shortest Cook Time... <%=Request.QueryString["Category"] %></h1>
