<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Recipes.aspx.cs" Inherits="Web2._0Assignment.Recipes" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    
    <link rel="stylesheet" href="~/Content/star-rating.css" />

    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:dbmt16abkConnectionString %>" SelectCommand="SELECT [Id], [Title], [IngredientList], [Instructions], [Picture], [Author], [PostDate], [CookTime], [Servings], [Category], [AverageScore] FROM [RecipesPlusRatings] ORDER BY [Title]"></asp:SqlDataSource>
   

    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1 style="font-family:'Times New Roman'; font-size:45px">Recipes A-Z...</h1>
